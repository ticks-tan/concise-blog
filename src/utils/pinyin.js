/**
 * Copy from https://github.com/creeperyang/pinyin
 */
		...
		function (N, A, t) {
				...
				return N || null === i
					? ("object" ===
							("undefined" == typeof Intl
								? "undefined"
								: n(Intl)) && Intl.Collator
							? ((f = new Intl.Collator(["zh-Hans-CN", "zh-CN"])),
							  (i =
									1 ===
									Intl.Collator.supportedLocalesOf(["zh-CN"])
										.length))
							: (i = !1),
					  i)
					: i;
			...
			function e(N) {
				...
				if (N.charCodeAt(0) < 256)
					return (U.type = H), (U.target = N), U;
				if ((r = f.compare(N, G)) < 0)
					return (U.type = u), (U.target = N), U;
				if (0 === r) (U.type = E), (e = 0);
				else {
